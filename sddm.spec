...
Version  : 0.20.0
Release  : 28
URL      : https://github.com/sddm/sddm/archive/v0.20.0/sddm-0.20.0.tar.gz
Source0  : https://github.com/sddm/sddm/archive/v0.20.0/sddm-0.20.0.tar.gz
...
Patch1: 0001-Install-pam-configs-where-clear-expects-them.patch
Patch2: 0002-Update-system-login-to-login-for-pam-file.patch
Patch3: 0005-autologin.pam-Use-login-instead-of-system-login.patch
...
%prep
%setup -q -n sddm-0.20.0
cd %{_builddir}/sddm-0.20.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694722557
mkdir -p clr-build
pushd clr-build
